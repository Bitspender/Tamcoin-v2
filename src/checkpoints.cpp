...
namespace Checkpoints
{
    ...
    // Tamcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // Tamcoin: get last synchronized checkpoint
    ...
    // Tamcoin: only descendant of current sync-checkpoint is allowed
    ...
    // Tamcoin: reset synchronized checkpoint to last hardened checkpoint
...
// Tamcoin: sync-checkpoint master key
...
// Tamcoin: verify signature of sync-checkpoint message
...
// Tamcoin: process synchronized checkpoint
