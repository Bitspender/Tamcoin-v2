        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start Tamcoin on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start Tamcoin after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the Tamcoin client port on the router. This only works when your router supports UPnP and it is enabled."));
    ...
    QLabel *fee_help = new QLabel(tr("Mandatory network transaction fee per kB transferred. Most transactions are 1 kB and incur a 0.01 TAM fee. Note: transfer size may increase depending on the number of input transactions required to be added together to fund the payment."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show Tamcoin addresses in the transaction list"));
