...
boost::filesystem::path GetConfigFile()
{
    ...
    fs::path pathConfigFile(GetArg("-conf", "Tamcoin.conf"));
...
boost::filesystem::path GetPidFile()
{
    ...
    fs::path pathPidFile(GetArg("-pid", "Tamcoind.pid"));
...
{
    return GetAutostartDir() / "Tamcoin.desktop";
}
