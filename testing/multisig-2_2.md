...
Alice sends 360 TAM to the multisig address.
...
The transaction will have 360 TAM (Alice's coins) as input and 359.99 TAM as output (because of the mandatory 0.01 TAM transaction fee; the transaction won't be accepted by the network without it).
